...
export declare class NbFirebaseAppleStrategy extends NbFirebaseBaseStrategy {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<NbFirebaseAppleStrategy, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<NbFirebaseAppleStrategy>;
}
